...
#Surface points:
boundary_points_surface = np.stack((
    Lunar_surface_data_loader1.x_coord,
...
surface_dataset = TensorDataset(
    boundary_points_surface_full,
    B_measured_surface_full,
)
surface_loader = DataLoader(
    surface_dataset,
...
# Initial sampling
boundary_dataset = TensorDataset(
    boundary_points_full,
    B_measured_full,
)
