...
from lunar_PINNversion.evaluation.evaluate_run import output_dir
...
surface_data_filename = '/home/memolnar/Data/Lunar_magnetism/LRO/LRO_data/520/LRO_combined_520V.csv'
...
Lunar_surface_data_loader1 = Lunar_surface_ER_data_loader(filename=surface_data_filename)

plot_four_component_mollweide(Lunar_surface_data_loader1.phi,
                              Lunar_surface_data_loader1.theta,
                              Lunar_surface_data_loader1.alpha_c, Lunar_surface_data_loader1.B_sc,
                              Lunar_surface_data_loader1.B,
                              Lunar_surface_data_loader1.B,
                              output_file=f"{output_dir}/surface_ER_field.png",
                              cnorm='symlog', vlims=[1, 100],
                              figsize=(10, 10),
                              titles=None,
...
B_measured_surface      = torch.tensor(Lunar_surface_data_loader1.B,
...
pinn.train_pinn_with_surface_data(inner_loader, boundary_loader,
                ...
                resume_from="/home/memolnar/Projects/lunarmagnetism/Outputs/real_data/LRO_ER_surface_data_v1/checkpoint_latest.pt",  # Path to checkpoint to resume from
